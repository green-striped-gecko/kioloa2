...
## W05 VCF Filtering for SNP Quality Control {.unnumbered}
...
<img src="images/renee.png" width="200" />
</div>
...
[Intro to Galaxy](https://galaxyproject.github.io/training-material/topics/introduction/tutorials/galaxy-intro-short/tutorial.html)

[SNP Calling](https://australianbiocommons.github.io/how-to-guides/stacks_workflows/stacks)
...
```{r loadlibs, warning=FALSE, message=FALSE, eval=FALSE}
library(rdiversity)
library(dartRverse)
library(dplyr)
```
