...
author: "Arthur Georges, Ching-Ching Lau & Diana Robledo"
date: "9 March 2026"
output:
  learnr::tutorial:
    progressive: false
...
## W02 dartR Intro, Data Manipulation & Filtering {.unnumbered}
...
<img src="images/arthur.png" width="200" />
<img src="images/chingching.png" width="200" />
<img src="images/diana.png" width="200" />
</div>
...
1.  Learn the basic usage of dartR.base
...
```{r output=FALSE}
new.gl <- gl.filter.sexlinked(LBP, system = "xy")
new.gl
new.gl@n.loc
```
...
For more guidance see the [ebook](http://georges.biomatix.org/storage/app/media/eBook%20Introduction%20to%20dartR/eBook1_Getting_Started_with_dartR.pdf).
