...
## W14 Simulations for Conservation Genetics

![](images/luis.png){.class width="200" height="200"} ![](images/bernd.png){.class width="200" height="200"}
...
start_pop <- gl.sim.Neconst(ninds = 500, nlocs = 1000,mutation_rate = 1e-8)
...
```{r ex73_3a, eval=FALSE}
gl.sim.offspring(fathers = pop1, mothers = pop1, noffpermother = 1)
```
