...
![](images/chris.png){.class width="200" height="200"} ![](images/luciano.png){.class width="200" height="200"}
...
library(melfuR)  #install via github: devtools::install_github("pygmyperch/melfuR")
```
...
```{r biooracle_demo, eval=TRUE, warning=FALSE, message=FALSE}
